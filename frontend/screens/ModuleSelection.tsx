...
export const ModuleSelection: React.FC<ModuleSelectionProps> = ({ onSelectModule }) => {
  return (
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-6xl w-full z-10">
        {tracks.map((track, index) => (
          <motion.button
            ...
            whileTap={{ scale: 0.98 }}
            onClick={() => onSelectModule(track.id)}
          ...
          >
            ...
            <div className="relative h-full bg-white/5 backdrop-blur-xl border border-white/10 p-8 rounded-2xl hover:border-white/20 transition-colors flex flex-col">
              ...
              <div className={`w-full py-3 rounded-xl font-bold text-center transition-all mt-auto
                                ${track.recommended
